...
Objektif koşul aşağıdakilerden biri olabilir:

* Belirli süreli iş (Örn. sergi, konferans)
* Belirli bir işin tamamlanması (Örn. inşaatın bitirilmesi, projenin bitirilmesi)
* Belirli bir olgunun ortaya çıkması (Örn. hastalık, hamilelik, askerlik gibi bir
nedenle izini olan ve iş sözleşmesi askıya alınan işçinin yerine başka bir
işçiyle belirli süreli sözleşme yapılması)

Zaman içinde mal ve hizmet üretiminin devam ettiği, faaliyetinin sürekliliği
esas olan işlerde objektif nedenler ortaya çıkmadıkça kural olarak belirli
süreli iş sözleşmesiyle işçi çalıştırmak mümkün değildir.
...
.. Analık izni, ebeveyn izni, işçinin askerlik hizmeti ve iş sözleşmesinin
...
Geçici işçi çalıştıran işveren, grev ve lokavtın uygulanması sırasında Toplu İş
Sözleşmesi Kanununun 65 inci maddesi hükümleri uyarınca greve katılamayacak
işçiler hariç olmak üzere geçici iş ilişkisiyle işçi çalıştıramaz.
...
sağlama sözleşmesi ile çalışan işçi, engelli ve eski hükümlü çalıştırma
zorunluluğu bakımından özel istihdam bürosu ve geçici işçi çalıştıran işverenin
işçi sayısına dâhil edilmez.
...
CAUTION: Toplu işten çıkarma için sendikanın rızasının alınması söz konusu
değildir.
...
TIP: *İşyeri uygulaması*, işveren tarafından yasal veya akdi bir zorunluluk
bulunmaksızın bir menfaatin tek taraflı olarak devamlı şekilde (en az 3 defa)
ve aynı koşullarla sağlanmasıdır.
...
CAUTION: Belirli süreli iş sözleşmesi kanunun aradığı objektif nedenler olmadan
yapılmışsa belirsiz süreli iş sözleşmesi olarak kabul edilir. Yargıtay'a göre
belirli süreli iş sözleşmesinin söz konusu olduğu bir davada, uyuşmazlık konusu
olmasa bile kanunda aranan bu objektif koşullar incelenmelidir. Yapılan
inceleme sonucunda objektif koşulları taşımadığı gerekçesiyle sözleşme belirsiz
süreli iş sözleşmesi olarak kabul edilecekse bakiye alacak istenemez. Doktrin
Yargıtay'ın bu kararını eleştirerek, işçinin lehine olacaksa bakiye alacağın
istenebilmesi gerektiğini savunmaktadır.
...
yürürlüğe girinceye kadar iş sözleşmesi hükmü olarak devam eder. Buna toplu iş
sözleşmesinin *art etkisi* denir. Ancak, art etkinin söz konusu olabilmesi için
iş sözleşmesinin toplu iş sözleşmesinin yürürlükte olduğu zaman dilimi
içerisinde yapılmış olması gerekir. *Sona eren toplu iş sözleşmelerinin art
etkisi, toplu iş sözleşmesi sona erdikten sonra yapılan iş sözleşmelerini
etkilemez.*
...
. Sigortalı olmaksızın avukatlık stajı yapılan süre
...
=== SİGORTALILIĞIN HÜKMEN TESPİTİ DAVASI

İşvereni tarafından kuruma bildirilmeyen veya eksik bildirilen sigortalılara
haklarını korumak için sigortalılığın hükmen tespiti davası açma hakkı
tanınmıştır.
