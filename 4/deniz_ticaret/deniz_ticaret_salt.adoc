...
. *Taşımanın sözleşmede kararlaştırılan gemi ile yapılması*: Taşıyan sözleşme
ile kararlaştırılan gemiden başka bir gemiye malları yüklerse bundan doğacak
zararlardan sorumlu olur. Ancak taşıyan, mallar kararlaştırılmış gemiyi
yüklenmiş olsaydı da bu zararın meydana geleceğini ispatlarsa sorumluluktan
kurtulabilir.